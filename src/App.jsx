...
export default function HomeCafePOS() {
  ...
  const dailyRevenue = dailySales.reduce((s, o) => s + o.total, 0);
  const dailyCost = dailySales.reduce((s, o) => s + o.cost, 0);
  const dailyProfit = dailyRevenue - dailyCost;
  const uniqueCustomersToday = new Set(dailySales.filter((s) => s.customer).map((s) => s.customer.toLowerCase())).size;
  ...
  const exportOrdersCSV = () => {
    ...
    const header = "Order #,Time,Customer,Items,Revenue,Cost,Profit";
    const rows = dailySales.map((sale, i) => [
      i + 1,
    ...
    downloadCSV(`cafe-au-may-orders-${new Date().toISOString().slice(0, 10)}.csv`, [header, ...rows].join("\n"));
  };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        justifyContent: "space-between", boxShadow: "0 2px 20px rgba(43,33,24,0.15)",
      }}>
        <div style={{ display: "flex", alignItems: "baseline", gap: "12px" }}>
          <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: "28px", fontWeight: 400, letterSpacing: "-0.5px" }}>
            Cafe Au May
          </span>
        ...
        <div style={{ display: "flex", gap: "4px" }}>
          {[
            ...
            { key: "menu-editor", label: "Menu & Pricing" },
            { key: "daily-summary", label: "Today's P&L" },
          ...
          <div style={{
            ...
            <div style={{ padding: "16px 20px 12px", borderBottom: "1px solid #f0ebe4", position: "relative" }}>
              ...
              {showSuggestions && suggestions.length > 0 && (
                <div style={{
                  ...
                  boxShadow: "0 8px 24px rgba(43,33,24,0.1)", zIndex: 10, overflow: "hidden", marginTop: "4px",
                }}>
            ...
            <div style={{ padding: "14px 20px 10px", borderBottom: "1px solid #f0ebe4" }}>
              ...
              <span style={{
                ...
                {order.reduce((s, o) => s + o.qty, 0)} items
              </span>
            </div>
            ...
            <div style={{ padding: "16px 20px", borderTop: "2px solid #2b2118", background: "#fdfcfa" }}>
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                <button onClick={completeOrder} style={{
                  ...
                  background: order.length > 0 ? "#2b2118" : "#d5cbc0", color: "#faf6f1",
                  cursor: order.length > 0 ? "pointer" : "default", fontSize: "15px", fontWeight: 700,
      ...
      {/* ═══════════════════ MENU EDITOR ═══════════════════ */}
      {view === "menu-editor" && (
        <div style={{ flex: 1, padding: "24px 32px", overflowY: "auto", maxWidth: "900px" }}>
          <div style={{ marginBottom: "28px" }}>
            <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: "28px", margin: "0 0 4px" }}>Menu & Pricing</h2>
                  ...
                  <div key={item.id} style={{
                    ...
                    {!isEditing ? (
                      <>
                        ...
                        <span style={{ fontSize: "13px", color: "#9a8b7c", minWidth: "80px" }}>Cost: ${item.cost.toFixed(2)}</span>
      ...
      {view === "daily-summary" && (
        <div style={{ flex: 1, padding: "24px 32px", overflowY: "auto", maxWidth: "900px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
            <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: "28px", margin: 0 }}>Today's P&L</h2>
            {dailySales.length > 0 && (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "16px", marginBottom: "32px" }}>
            {[
              ...
              { label: "Customers", value: uniqueCustomersToday, color: "#2b2118" },
            ].map((stat) => (
              <div key={stat.label} style={{ background: "#fff", borderRadius: "16px", padding: "20px", border: "1.5px solid #f0ebe4" }}>
                <div style={{ fontSize: "12px", color: "#9a8b7c", letterSpacing: "1px", textTransform: "uppercase", marginBottom: "8px" }}>{stat.label}</div>
                <div style={{ fontFamily: "'Instrument Serif', serif", fontSize: "32px", color: stat.color }}>{stat.value}</div>
              </div>
            ))}
          </div>

          <h3 style={{ fontSize: "12px", letterSpacing: "2px", textTransform: "uppercase", color: "#9a8b7c", marginBottom: "12px", fontWeight: 500 }}>
            Completed Orders ({dailySales.length})
          </h3>
          {dailySales.length === 0 && (
            <div style={{
              ...
              No sales yet today. Go to Register to ring up orders.
            </div>
          )}
        ...
        <div style={{ flex: 1, padding: "24px 32px", overflowY: "auto", maxWidth: "900px" }}>
          <div style={{ marginBottom: "28px" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "4px" }}>
              <h2 style={{ fontFamily: "'Instrument Serif', serif", fontSize: "28px", margin: 0 }}>Customers</h2>
          ...
          {topCustomers.length > 0 && (
            <>
              {/* Top 3 Leaderboard */}
              <div style={{ display: "grid", gridTemplateColumns: `repeat(${Math.min(topCustomers.length, 3)}, 1fr)`, gap: "16px", marginBottom: "28px" }}>
                  ...
                  return (
                    <div key={c.name} style={{
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
                        ...
                        <span style={{ fontFamily: "'Instrument Serif', serif", fontSize: "20px" }}>{c.name}</span>
                      </div>
